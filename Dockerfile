...
RUN apt-get install -y php7.1 php7.1-curl php7.1-gd php7.1-mbstring php7.1-imagick php7.1-mysql php7.1-xdebug php7.1-simplexml php7.1-zip php7.1-soap php7.1-apcu php-apcu-bc
